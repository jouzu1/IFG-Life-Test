...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "marketplace_checkout", name = "Marketplace_checkout", hidden = true)
@ProcessInput(processName = "marketplace_checkout")
public class Marketplace_checkoutModelInput implements Model, MapInput, MapInputId, MapOutput, MappableToModel<Marketplace_checkoutModel> {
    ...
    @Override()
    public Marketplace_checkoutModel toModel() {
        Marketplace_checkoutModel result = new Marketplace_checkoutModel();
